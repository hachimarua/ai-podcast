...
PUBLIC_CHECK_KEYS = {
    ...
    "passed", "issues", "warnings", "duration_seconds", "target_duration_seconds",
    "duration_headroom_seconds", "long_duration_warning", "mean_volume_db", "max_volume_db",
    "long_silence_seconds", "long_silence_ratio", "file_size_bytes", "thresholds",
    "min_duration_seconds", "max_duration_seconds", "hard_max_duration_seconds",
...
PUBLIC_CHECK_STRINGS = PUBLIC_NEWS_SOURCES | {
    ...
    "mean_volume_too_quiet", "mean_volume_too_loud", "peak_too_high",
    "too_much_long_silence",
