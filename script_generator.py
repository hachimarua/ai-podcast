...
- 「必須」は音声では「ひっす」と明瞭に読める表記にし、「Hugging Face」は「ハギングフェイス」、「DeepMind」は「ディープマインド」、「TechCrunch」は「テッククランチ」、「GitHub Actions」は「ギットハブアクションズ」、「Cloudflare」は「クラウドフレア」のように表記してください。発音が崩れやすい英語固有名詞を途中で省略しないでください。
